							...
							<h4 class="media-heading">
								...
								<small style="display: inline-block">
									...
									<div class="">
										...
										<?= $this->Form->postLink(__('Supprimer'), ['controller' => 'Tickets', 'action' => 'deleteComment',
										$comment->id], ['class' => 'btn-small btn-danger', 'confirm' => __('Voulez vous vraiment supprimer ce commentaire?')]) ?>
									</div>
									<?php endif; ?>
								</small>
							</h4>
